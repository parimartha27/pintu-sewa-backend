...
public class Constant {
    ...
    public static final String SUCCESS_CODE = "PRD-00-000";
    public static final String SUCCESS_MESSAGE = "SUCCESS";

    public static final String FAILED_CODE = "PRD-99-999";
    public static final String FAILED_MESSAGE = "FAILED";

    public static final String BAD_REQUEST_CODE = "PRD-99-400";
